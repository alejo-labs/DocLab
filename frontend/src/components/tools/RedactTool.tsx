...
export function RedactTool(_props: ToolEngineProps) {
  ...
  return (
    <div className="space-y-3 lg:h-full lg:flex lg:flex-col lg:overflow-hidden">
      ...
      <p className="font-mono text-[11px] text-graphite shrink-0">El resto del texto de la página <strong>se conserva seleccionable</strong>; solo desaparece lo que tapes.</p>
