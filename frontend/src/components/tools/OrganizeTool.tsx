...
export function OrganizeTool({ preset }: ToolEngineProps) {
  ...
  return (
    <div className="space-y-5">
      ...
      <div ref={gridRef} className="grid gap-3 lg:max-h-[calc(100vh-12rem)] lg:overflow-y-auto p-1" style={gridStyle}>
        {pages.map((page, index) => (
          ...
          >
            <div
              className="relative grid aspect-[3/4] cursor-pointer place-items-center overflow-hidden bg-paper-raised"
