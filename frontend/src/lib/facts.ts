...
export const FACTS: readonly string[] = [
  'El formato PDF nació en 1993, creado por Adobe. Su objetivo: que un documento se viera igual en cualquier ordenador.',
  ...
  'OCR significa Reconocimiento Óptico de Caracteres: convierte la imagen de un texto escaneado en texto de verdad, seleccionable.',
  ...
  'DocLab autoaloja sus tipografías y motores: no pide nada a servidores de terceros que pudieran observar tu actividad.',
  ...
  'La firma con contraseña de un PDF cifra el contenido; sin la clave correcta, ni siquiera se puede abrir.',
