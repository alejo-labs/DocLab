    ...
    <>
      ...
      <Prose>
        ...
        <Section title="Uso aceptable">
          <p>Te comprometes a usar DocLab conforme a la ley. En particular, no debes hacer lo siguiente.</p>
          <ul className="list-disc space-y-1.5 pl-5">
            <li>Procesar documentos sobre los que no tengas derechos o autorización.</li>
            <li>Vulnerar derechos de terceros, como la propiedad intelectual o la privacidad.</li>
