...
const headers: { name: string; value: string; why: string }[] = [
  ...
  { name: 'default-src', value: "'self'", why: 'Todo (imágenes, fuentes, conexiones) parte del mismo origen, sin nada externo por defecto.' },
  ...
  { name: 'frame-ancestors', value: "'none'", why: 'La página no puede incrustarse en un iframe, lo que protege frente al clickjacking.' },
  { name: 'X-Content-Type-Options', value: 'nosniff', why: 'El navegador no «adivina» tipos MIME, así evita que un recurso se ejecute como algo que no es.' },
...
export function Security() {
  usePageMeta(
    'Seguridad · DocLab',
    'Seguridad por arquitectura, con procesamiento en el dispositivo, WebAssembly en sandbox, CSP estricta, cifrado AES-256 y cero retención. Así protege DocLab tus documentos.',
  );
  return (
    <>
      <PageHero
      ...
      <Prose>
        <Section title="Modelo de amenazas, en corto">
          <p>
            ...
            como filtraciones del servidor, copias residuales, accesos indebidos, requerimientos a terceros o inspección
            en tránsito. Lo que no existe no se puede comprometer.
          </p>
        ...
        <Section title="WebAssembly en un entorno aislado">
          <p>
            ...
            sandbox del navegador, sin acceso al sistema de archivos, sin red y sin más permisos que los de la pestaña.
        ...
        <Section title="Prácticas de código">
          <ul className="list-disc space-y-1.5 pl-5">
            <li>Sin <Mono>dangerouslySetInnerHTML</Mono> en toda la aplicación, así que no hay superficie de XSS por inyección de HTML.</li>
            <li>TypeScript estricto y <Mono>oxlint</Mono> a cero avisos, con 51 tests de lógica pura que blindan las funciones críticas.</li>
            <li>Dependencias solo con licencias permisivas (MIT, Apache, ISC), sin nada copyleft que comprometa el proyecto.</li>
            <li>Assets de terceros como fuentes y motores <strong>autoalojados</strong>, con cero peticiones a dominios ajenos.</li>
          </ul>
        </Section>
        ...
        <Section title="Honestidad sobre los límites">
          <p>
            ...
            de PDF a Word de documentos muy complejos es aproximada y «censurar» rasteriza para eliminar de verdad el
